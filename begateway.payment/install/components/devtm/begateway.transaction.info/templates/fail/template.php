...
<section id="fail">
	...
	<div id="amount"><?= Loc::getMessage("DEVTM_BEGATEWAY_FAIL_AMOUNT")?> <span><?= $arResult->order->amount?></span> <span><?= $arResult->order->currency ?></span></div>
	<div id="uid-transaction"><?= Loc::getMessage("DEVTM_BEGATEWAY_FAIL_UID")?> <span><?= $arResult->gateway_response->$type->uid?></span></div>
	<div id="rejection-reason"><?= Loc::getMessage("DEVTM_BEGATEWAY_FAIL_REJECTION_REASON")?> <span><?= $arResult->gateway_response->$type->message?></span></div>
	<br/>
